        ...
        for r in [6,15]:
            ...
            for x in [[[0],[0]],[[2],[6]]]:
                ...
                for t in range (0,N_iter):
                    ...
                    w1=np.random.normal(0, np.sqrt(10), 1)
                    w2=np.random.normal(0, np.sqrt(10), 1)
                    
                    # process noise
                    W =np.array([[w1[0]],[w2[0]]])
                
                    e=np.random.normal(0, np.sqrt(6), 1)
                    ...
                    if(t <=20):
                        ...
                        #print(t)
                        fig.savefig('images_s1/'+str(num)+'.png')
                ...
                for i in range(N_iter):
                    ...
                    # lists for x1,x2 with the noise
                    ...
                    Kgrow1.append(outputK[i][0])
                    Kgrow2.append(outputK[i][1])
                ...
                plt.ylabel('K')
                fig.savefig('images__s1/'+str(num)+'.png')
                '''
